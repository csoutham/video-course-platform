...
test('manual entitlement grant and revoke commands work', function (): void {
...
test('stripe reprocess command replays stored event', function (): void {
    $user = User::factory()->create();
    $course = Course::factory()->published()->create();
...
test('stream sync durations command updates lesson lengths', function (): void {
